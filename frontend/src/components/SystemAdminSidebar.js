...
const SystemAdminSidebar = ({ activeSection, onSectionChange }) => {
  const menuItems = [
    {
      id: 'overview',
      label: 'Overview',
  ...
  return (
    <aside className="w-72 bg-gradient-to-br from-gray-900 to-gray-800 text-white min-h-screen">
      <div className="p-6">
        <div className="mb-8">
